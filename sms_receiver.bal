...
//Set the URL in the SMS Application data as http://localhost:9000/sms/receiver
...
service<http:Service> sms bind { port: 9000 } {
        ...
        receiver(endpoint caller, http:Request req) {
            http:Response res = new;
                ...
                //Create the file
                var destinationChannel = getFileCharacterChannel("./files/smsreceiverLog.txt",io:WRITE, "UTF-8");
